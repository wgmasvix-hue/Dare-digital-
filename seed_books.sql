...
CREATE TABLE IF NOT EXISTS public.books (
  ...
  source text DEFAULT 'Dare Library',
  institution_id text,
...
BEGIN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE tablename = 'books' AND policyname = 'Allow anon insert on books'
    ) THEN
...
('openstax-psych-1', 'Psychology 2e', 'Rose M. Spielman, William J. Jenkins, Marilyn D. Lovett', 'OpenStax', 'Humanities', 'Psychology', 'https://assets.openstax.org/oscms-prodcms/media/documents/Psychology2e-OP_8S58J3e.pdf_cover.jpg', 'https://assets.openstax.org/oscms-prodcms/media/documents/Psychology2e-OP.pdf', 'open_access', 2020, 'Psychology 2e for the single-semester introduction to psychology course.', 'CC BY 4.0', 13200, 4.8, 784, 'pdf', false, '[]', 'OpenStax', 'openstax'),
('openstax-hist-1', 'U.S. History', 'P. Scott Corbett, Volker Janssen, John M. Lund', 'OpenStax', 'Humanities', 'History', 'https://assets.openstax.org/oscms-prodcms/media/documents/USHistory-OP_8E58J3e.pdf_cover.jpg', 'https://assets.openstax.org/oscms-prodcms/media/documents/USHistory-OP.pdf', 'open_access', 2014, 'U.S. History covers the chronological history of the United States.', 'CC BY 4.0', 10100, 4.6, 1086, 'pdf', false, '[]', 'OpenStax', 'openstax')
ON CONFLICT (id) DO NOTHING;

-- OPENSTAX_EXPANDED
INSERT INTO public.books (id, title, author_names, publisher_name, faculty, subject, cover_image_url, file_url, access_model, year_published, description, license_type, total_downloads, average_rating, page_count, source, institution_id)
VALUES
('openstax-fundamentals-nursing', 'Fundamentals of Nursing', 'Christy Bowen', 'OpenStax', 'Health', 'Nursing', 'https://assets.openstax.org/oscms-prodcms/media/documents/FundamentalsOfNursing_cover.jpg', 'https://assets.openstax.org/oscms-prodcms/media/documents/FundamentalsOfNursing.pdf', 'open_access', 2023, 'Fundamentals of Nursing is designed to meet the scope and sequence of an introductory nursing course, providing a solid foundation for nursing practice.', 'CC BY 4.0', 4500, 4.9, 1100, 'OpenStax', 'openstax'),
...
('openstax-precalc-1', 'Precalculus', 'Jay Abramson', 'OpenStax', 'STEM', 'Mathematics', 'https://assets.openstax.org/oscms-prodcms/media/documents/Precalculus-OP_cover.jpg', 'https://assets.openstax.org/oscms-prodcms/media/documents/Precalculus-OP.pdf', 'open_access', 2014, 'Precalculus is intended for college-level precalculus students.', 'CC BY 4.0', 7200, 4.5, 1156, 'OpenStax', 'openstax'),
('openstax-alg-1', 'College Algebra', 'Jay Abramson', 'OpenStax', 'STEM', 'Mathematics', 'https://assets.openstax.org/oscms-prodcms/media/documents/CollegeAlgebra-OP_cover.jpg', 'https://assets.openstax.org/oscms-prodcms/media/documents/CollegeAlgebra-OP.pdf', 'open_access', 2015, 'College Algebra provides a comprehensive exploration of algebraic principles.', 'CC BY 4.0', 9100, 4.7, 1076, 'OpenStax', 'openstax'),
('openstax-micro-1', 'Microbiology', 'Nina Parker, Mark Schneegurt', 'OpenStax', 'Health', 'Microbiology', 'https://assets.openstax.org/oscms-prodcms/media/documents/Microbiology-OP_cover.jpg', 'https://assets.openstax.org/oscms-prodcms/media/documents/Microbiology-OP.pdf', 'open_access', 2016, 'Microbiology covers the scope and sequence requirements for a single-semester microbiology course.', 'CC BY 4.0', 6400, 4.8, 1322, 'OpenStax', 'openstax'),
('openstax-ap-1', 'Anatomy and Physiology', 'J. Gordon Betts, Kelly A. Young', 'OpenStax', 'Health', 'Medicine', 'https://assets.openstax.org/oscms-prodcms/media/documents/AnatomyandPhysiology-OP_cover.jpg', 'https://assets.openstax.org/oscms-prodcms/media/documents/AnatomyandPhysiology-OP.pdf', 'open_access', 2013, 'Anatomy and Physiology is a dynamic textbook for the two-semester human anatomy and physiology course.', 'CC BY 4.0', 12000, 4.9, 1418, 'OpenStax', 'openstax'),
('openstax-conbio-1', 'Concepts of Biology', 'Samantha Fowler, Rebecca Roush', 'OpenStax', 'STEM', 'Biology', 'https://assets.openstax.org/oscms-prodcms/media/documents/ConceptsofBiology-OP_cover.jpg', 'https://assets.openstax.org/oscms-prodcms/media/documents/ConceptsofBiology-OP.pdf', 'open_access', 2013, 'Concepts of Biology is designed for the single-semester introduction to biology course.', 'CC BY 4.0', 15000, 4.7, 612, 'OpenStax', 'openstax'),
('openstax-nutri-1', 'Nutrition for Nurses', 'OpenStax', 'OpenStax', 'Health', 'Nursing', 'https://assets.openstax.org/oscms-prodcms/media/documents/NutritionforNurses-OP_cover.jpg', 'https://assets.openstax.org/oscms-prodcms/media/documents/NutritionforNurses-OP.pdf', 'open_access', 2023, 'Nutrition for Nurses is designed to meet the scope and sequence of an introductory nutrition course for nursing students.', 'CC BY 4.0', 3200, 4.8, 450, 'OpenStax', 'openstax'),
('openstax-acc-1', 'Principles of Accounting', 'Mitchell Franklin, Patty Graybeal', 'OpenStax', 'Business', 'Accounting', 'https://assets.openstax.org/oscms-prodcms/media/documents/PrinciplesofAccountingVolume1-OP_cover.jpg', 'https://assets.openstax.org/oscms-prodcms/media/documents/PrinciplesofAccountingVolume1-OP.pdf', 'open_access', 2019, 'Principles of Accounting is designed to meet the scope and sequence requirements of a two-semester accounting course.', 'CC BY 4.0', 5600, 4.5, 800, 'OpenStax', 'openstax'),
('openstax-buslaw-1', 'Business Law I Essentials', 'Mirande-Rae Werger', 'OpenStax', 'Law', 'Law', 'https://assets.openstax.org/oscms-prodcms/media/documents/BusinessLawIEssentials-OP_cover.jpg', 'https://assets.openstax.org/oscms-prodcms/media/documents/BusinessLawIEssentials-OP.pdf', 'open_access', 2019, 'Business Law I Essentials is a brief introductory textbook designed to meet the scope and sequence requirements of courses on Business Law.', 'CC BY 4.0', 4100, 4.4, 350, 'OpenStax', 'openstax'),
('openstax-bus-1', 'Introduction to Business', 'Lawrence J. Gitman, Carl McDaniel', 'OpenStax', 'Business', 'Business', 'https://assets.openstax.org/oscms-prodcms/media/documents/IntroductiontoBusiness-OP_cover.jpg', 'https://assets.openstax.org/oscms-prodcms/media/documents/IntroductiontoBusiness-OP.pdf', 'open_access', 2018, 'Introduction to Business covers the scope and sequence of most introductory business courses.', 'CC BY 4.0', 7800, 4.6, 650, 'OpenStax', 'openstax'),
('openstax-mgmt-1', 'Principles of Management', 'David S. Bright, Anastasios G. Cortes', 'OpenStax', 'Business', 'Management', 'https://assets.openstax.org/oscms-prodcms/media/documents/PrinciplesofManagement-OP_cover.jpg', 'https://assets.openstax.org/oscms-prodcms/media/documents/PrinciplesofManagement-OP.pdf', 'open_access', 2019, 'Principles of Management is designed to meet the scope and sequence requirements of the introductory course on management.', 'CC BY 4.0', 6200, 4.7, 550, 'OpenStax', 'openstax'),
('openstax-mktg-1', 'Principles of Marketing', 'OpenStax', 'OpenStax', 'Business', 'Marketing', 'https://assets.openstax.org/oscms-prodcms/media/documents/PrinciplesofMarketing-OP_cover.jpg', 'https://assets.openstax.org/oscms-prodcms/media/documents/PrinciplesofMarketing-OP.pdf', 'open_access', 2022, 'Principles of Marketing is designed to meet the scope and sequence requirements of the introductory course on marketing.', 'CC BY 4.0', 3500, 4.5, 500, 'OpenStax', 'openstax'),
('openstax-polsci-1', 'Introduction to Political Science', 'Mark Alleman', 'OpenStax', 'Humanities', 'Political Science', 'https://assets.openstax.org/oscms-prodcms/media/documents/IntroductiontoPoliticalScience-OP_cover.jpg', 'https://assets.openstax.org/oscms-prodcms/media/documents/IntroductiontoPoliticalScience-OP.pdf', 'open_access', 2022, 'Introduction to Political Science provides a comprehensive overview of the field.', 'CC BY 4.0', 2800, 4.6, 600, 'OpenStax', 'openstax'),
('openstax-phil-1', 'Introduction to Philosophy', 'Nathan Smith', 'OpenStax', 'Humanities', 'Philosophy', 'https://assets.openstax.org/oscms-prodcms/media/documents/IntroductiontoPhilosophy-OP_cover.jpg', 'https://assets.openstax.org/oscms-prodcms/media/documents/IntroductiontoPhilosophy-OP.pdf', 'open_access', 2022, 'Introduction to Philosophy provides a comprehensive overview of the field.', 'CC BY 4.0', 2500, 4.7, 500, 'OpenStax', 'openstax')
ON CONFLICT (id) DO NOTHING;

-- AGRICULTURE_OER
INSERT INTO public.books (id, title, author_names, publisher_name, faculty, subject, cover_image_url, file_url, access_model, year_published, description, license_type, total_downloads, average_rating, page_count, is_featured, pillars, source, institution_id)
VALUES
('fao-csa-1', 'Climate-Smart Agriculture Sourcebook', 'FAO', 'FAO', 'Agriculture', 'Agriculture', 'https://www.fao.org/3/i3325e/i3325e_cover.jpg', 'https://www.fao.org/3/i3325e/i3325e.pdf', 'open_access', 2013, 'The Climate-Smart Agriculture Sourcebook provides guidance on how to implement CSA.', 'CC BY-NC-SA 3.0 IGO', 4500, 4.8, 550, true, '["Research", "Innovation", "Industrialisation"]', 'FAO', 'fao'),
('fao-soils-1', 'Soils and Pulses', 'FAO', 'FAO', 'Agriculture', 'Soil Science', 'https://www.fao.org/3/i5555e/i5555e_cover.jpg', 'https://www.fao.org/3/i5555e/i5555e.pdf', 'open_access', 2016, 'Soils and Pulses explores the relationship between soil health and pulse production.', 'CC BY-NC-SA 3.0 IGO', 3200, 4.7, 120, false, '[]', 'FAO', 'fao'),
('fao-postharvest-1', 'Post-Harvest Loss Reduction', 'FAO', 'FAO', 'Agriculture', 'Agricultural Engineering', 'https://www.fao.org/3/i1234e/i1234e_cover.jpg', 'https://www.fao.org/3/i1234e/i1234e.pdf', 'open_access', 2020, 'Guidelines for reducing post-harvest losses in developing countries.', 'CC BY-NC-SA 3.0 IGO', 2800, 4.6, 180, false, '[]', 'FAO', 'fao'),
('fao-fisheries-1', 'State of World Fisheries 2024', 'FAO', 'FAO', 'Agriculture', 'Fisheries', 'https://www.fao.org/3/cc0461en/cc0461en_cover.jpg', 'https://www.fao.org/3/cc0461en/cc0461en.pdf', 'open_access', 2024, 'The latest report on the status of world fisheries and aquaculture.', 'CC BY-NC-SA 3.0 IGO', 1500, 4.9, 250, false, '[]', 'FAO', 'fao'),
('fao-irrigation-1', 'Irrigation Water Management', 'FAO', 'FAO', 'Agriculture', 'Irrigation', 'https://www.fao.org/3/i5678e/i5678e_cover.jpg', 'https://www.fao.org/3/i5678e/i5678e.pdf', 'open_access', 2018, 'Training manual on irrigation water management.', 'CC BY-NC-SA 3.0 IGO', 3900, 4.7, 150, false, '[]', 'FAO', 'fao'),
('fao-food-security-2023', 'The State of Food Security and Nutrition in the World 2023', 'FAO, IFAD, UNICEF, WFP and WHO', 'FAO', 'Agriculture', 'Food Security', 'https://www.fao.org/3/cc3017en/cc3017en_cover.jpg', 'https://www.fao.org/3/cc3017en/cc3017en.pdf', 'open_access', 2023, 'Updates on the global food security status and nutrition.', 'CC BY-NC-SA 3.0 IGO', 5100, 4.8, 300, false, '[]', 'FAO', 'fao'),
('fao-save-grow', 'Save and Grow', 'FAO', 'FAO', 'Agriculture', 'Sustainable Agriculture', 'https://www.fao.org/3/i2215e/i2215e00.jpg', 'https://www.fao.org/3/i2215e/i2215e.pdf', 'open_access', 2011, 'A policymaker''s guide to the sustainable intensification of smallholder crop production.', 'CC BY-NC-SA 3.0 IGO', 4200, 4.7, 110, false, '[]', 'FAO', 'fao'),
('fao-organic-ag', 'Training Manual for Organic Agriculture', 'FAO', 'FAO', 'Agriculture', 'Organic Farming', 'https://www.fao.org/3/i4551e/i4551e_cover.jpg', 'https://www.fao.org/3/i4551e/i4551e.pdf', 'open_access', 2015, 'A comprehensive training manual for organic agriculture.', 'CC BY-NC-SA 3.0 IGO', 3800, 4.6, 220, false, '[]', 'FAO', 'fao')
ON CONFLICT (id) DO NOTHING;
