...
export default function Reader() {
  ...
  useEffect(() => {
    async function fetchBookAndCheckAccess() {
      try {
        ...
        // AI study guides can be manually generated by the user using the UI controls, preventing BAKO from blocking initial book viewing.

        // Update initial AI message with book context
        setAiMessages([
          { 
            role: 'assistant', 
            text: `Mhoro! I'm BAKO, your AI Tutor. I see you're reading **${bookData.title}** by ${bookData.author_names || 'various authors'}. Great choice — this is one of our most popular resources. How can I help you master it? I can summarize sections, explain concepts, generate practice questions, or help you take structured notes.` 
          }
        ]);
  ...
  const clearChat = () => {
    const greeting = book 
      ? `Mhoro! I'm BAKO, your AI Tutor. I see you're reading **${book.title}** by ${book.author_names || 'various authors'}. Great choice — this is one of our most popular resources. How can I help you master it? I can summarize sections, explain concepts, generate practice questions, or help you take structured notes.`
      : "Mhoro! I'm BAKO, your personal AI Tutor. I'm here to help you master the material in this book. \n\nI can summarize chapters, explain complex concepts, or test your knowledge with a quick quiz. What shall we tackle first?";
              ...
              <div className={styles.generatedBookContent}>
                {isGeneratingBook ? (
                  <div className={styles.generatingState}>
                    ...
                    <p>BAKO is analyzing the book to save your data budget.</p>
                  </div>
                ) : generatedBook ? (
